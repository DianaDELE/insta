...
class RegistrationController: UIViewController{
    ...
    private let plushPhotoButton: UIButton = {
        ...
        button.setImage(#imageLiteral(resourceName: "plus-2"),for: .normal)
    ...
    private let alreadyHaveAccountButton: UIButton = {
        let button = UIButton(type: .system)
        button.attributedTitle(firstPart: "Ya tienes una cuenta?  ", secondPart: "Entrar" )
    ...
    //animacion de que la pestaña regresa
